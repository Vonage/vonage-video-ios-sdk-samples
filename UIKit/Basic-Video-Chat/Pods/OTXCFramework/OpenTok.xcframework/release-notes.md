...
### Version 2.30.1 -- May 2025

* This version fixes an issue where, in some cases, sessions could not connect.

* This version fixes an issue with subscriber network stats and RTC stats reports sent by the `OTSubscriberKitNetworkStatsDelegate` and `OTSubscriberKitRtcStatsReportDelegate` delegates. 
