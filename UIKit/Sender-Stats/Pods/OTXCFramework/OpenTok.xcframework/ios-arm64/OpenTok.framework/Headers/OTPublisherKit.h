 ...
 *
 * These presets allow applying predefined bandwidth strategies without manually
 * specifying bitrates. Presets are mutually exclusive with manual bitrate configuration.
 *
 * See <[OTPublisherKit videoBitratePreset]> and
 * <a target="_top" href="https://tokbox.com/developer/guides/publisher-max-bitrate/ios/">Publisher Max Bitrate</a>.
 */
typedef NS_ENUM(NSInteger, OTVideoBitratePreset) {
    
    /**
     * Default preset. No extra restrictions are applied.
     *
     * This is the default mode.
     */
    OTVideoBitratePresetDefault = 0,
    
    /**
     * Bandwidth saver preset.
     *
     * Applies moderate constraints to reduce bandwidth usage while
     * maintaining reasonable video quality.
     */
    OTVideoBitratePresetBwSaver = 1,
    
    /**
     * Extra bandwidth saver preset.
     *
     * Applies aggressive constraints to minimize bandwidth usage.
     */
    OTVideoBitratePresetExtraBwSaver = 2,
    
    /**
     * Custom bitrate.
     *
     * Represents a manually configured bitrate set using <code>maxVideoBitrate</code>.
     * This value is returned for tracking purposes but cannot be set directly.
     * Setting <code>maxVideoBitrate</code> overrides any preset and switches this
     * property to <code>OTVideoBitratePresetCustom</code>.
     */
    OTVideoBitratePresetCustom = 3
};
...
/**
 * Whether to publish sender statistics (YES) or not (NO, the default).
 *
 * If this property is set to NO, the sender statistics subsystem will not be initialized
 * for the publisher.
 */
@property(nonatomic) BOOL senderStatisticsTrack;
...
/**
 * If set to NO, the microphone will be automatically switched off when all publishers
 * have muted their audio. Microphone will be automatically switched on again when at least one
 * publisher unmutes their audio.
 * If set to YES, mic will always remain switched on even when all publishers have muted their audio.
 * Be aware that when the microphone is switched off, callbacks like AudioLevel or AudioData
 * will no longer be invoked for the publishers.
...
/** @name Controlling the Publisher’s Video Bitrate Preset */
 ...
 * Setting this property to <code>0</code> clears any manual cap and reverts to 
 ...
 *
 * A value of <code>0</code> indicates that no explicit bitrate limit is applied 
 * and the stream operates under adaptive preset rules to optimize quality.
 *
 * Also see <[OTPublisherKit videoBitratePreset]> and
 * <a target="_top" href="https://tokbox.com/developer/guides/publisher-max-bitrate/ios/">Publisher Max Bitrate</a>.
 */
 ...
 *
 * This property configures a predefined bitrate strategy to balance video quality 
 * and bandwidth usage. Available presets include default behavior, moderate bandwidth 
 * saving, and aggressive bandwidth saving modes. Preset strategies allow control 
 ...
 * Setting <code>maxVideoBitrate</code> will override any preset and automatically 
 * change this property’s value to <code>OTVideoBitratePresetCustom</code>.
 *
 * Reading this property returns the currently active preset. If a custom bitrate 
 * has been manually set, the value will be <code>OTVideoBitratePresetCustom</code>.
 *
 * The default value is <code>OTVideoBitratePresetDefault</code>.
 *
 * Also see <[OTPublisherKit maxVideoBitrate]> and
 * <a target="_top" href="https://tokbox.com/developer/guides/publisher-max-bitrate/ios/">Publisher Max Bitrate</a>.
 */
...
* the Vonage Media Processor library</a>. 
* 
* <b>Important:</b> In version 2.27.4+ of the Vonage Video client SDK for iOS,
* you need to add the Vonage Media Library separately from the
* Vonage Video iOS SDK. For details, see
* <a href="https://tokbox.com/developer/guides/vonage-media-processor/ios/#vonage-media-library-integration">Vonage Media Library integration</a>.  
* Check additional information in the Vonage Media Library README.md file.
*
* <b>Note:</b> Media transformers
...
* @param name The name of the Vonage transformer.
...
/**
* Creates an instance of a Vonage audio transformer. For more information,
* see <a href="https://tokbox.com/developer/guides/vonage-media-processor/ios/">Using
* the Vonage Media Processor library</a>.
*
* <b>Important:</b> In version 2.27.4+ of the Vonage Video client SDK for iOS,
...
*
* @param name The name of the Vonage transformer.
* @param properties A JSON string with the properties of the Vonage audio transformer.
*/
- (nullable id)initWithName:(nonnull NSString*)name properties:(nonnull NSString *)properties;
