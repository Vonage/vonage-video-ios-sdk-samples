 ...
 *
 * @param plane The planes to assign.
 */
 ...
 * <i>Do not</i> call any OpenTok API methods (except those in the <OTVideoFrame> class) 
 * on the same thread that invokes this callback.
 * If you need to call an OpenTok API method (for example,
 * <OTPublisherKit> or <OTSubscriberKit> methods), 
